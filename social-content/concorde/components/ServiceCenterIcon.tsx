...
export interface ServiceCenterIconProps {
  size?: number;
...
export default function ServiceCenterIcon({ size = 24, state: controlled, title, className = "" }: ServiceCenterIconProps): JSX.Element {
      ...
      {!isActive && (
        <defs>
          {isHover ? (
            ...
            <linearGradient id={`${uid}g`} x1="6.22694" y1="-11.3077" x2="28.0368" y2="-6.01905" gradientUnits="userSpaceOnUse">
